...
class MastersControllerTest < ActionController::TestCase
  ...
  test "should create master" do
    assert_difference('Master.count') do
      post :create, master: { conversion: @master.conversion, item_name: @master.item_name, level: @master.level, mrp: @master.mrp, units: @master.units, uom: @master.uom }
    end
  ...
  test "should update master" do
    patch :update, id: @master, master: { conversion: @master.conversion, item_name: @master.item_name, level: @master.level, mrp: @master.mrp, units: @master.units, uom: @master.uom }
    assert_redirected_to master_path(assigns(:master))
  end
